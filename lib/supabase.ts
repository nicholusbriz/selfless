...
// NOTE: uploadProfileImage and deleteProfileImage have been removed.
// Profile images are now stored in Azure Blob Storage.
// Use the functions in @/lib/azure-storage instead,
// or POST to /api/user/upload-image from the client.
