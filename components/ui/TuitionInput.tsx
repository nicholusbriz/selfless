    ...
    <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-xl p-6">
      ...
      {!isEditing ? (
        <div className="space-y-3">
          ...
          {currentTuition && (
            <div className={`flex items-center gap-2 px-3 py-2 rounded-lg ${
              ...
              {tuitionPaid ? (
                <>
                  <span className="text-sm font-medium">✓ Tuition Paid</span>
                </>
              ) : (
                <>
                  <span className="text-sm font-medium">⚠ Tuition Pending</span>
                </>
              )}
            </div>
          )}
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-gray-400 text-sm mb-2">Enter total tuition amount</label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="0.00"
                className="w-full pl-8 pr-4 py-2 bg-black/50 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-violet-500"
                min="0"
                step="0.01"
              />
            </div>
