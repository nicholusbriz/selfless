...
export default function RotatingEarth({ width = 800, height = 600, className = "" }: RotatingEarthProps) {
  ...
  useEffect(() => {
    ...
    const radius = Math.min(containerWidth, containerHeight) / (isMobile ? 2.2 : 2.5)
    ...
    // Set up rotation and interaction - Start focused on Atlantic Ocean
    const rotation: [number, number] = [-30, 0]
    let autoRotate = true
