...
export default function CleaningTab() {
  ...
  const handleSearch = (term: string) => {
    ...
    // Search for student across all cleaning days
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          ...
          {/* Toggle for guidelines - works on both mobile and desktop */}
          <button
            onClick={() => setShowGuidelines(!showGuidelines)}
            className="flex items-center gap-1 text-xs text-purple-400 bg-purple-500/10 px-3 py-2 rounded-lg border border-purple-500/20 min-h-[44px]"
          >
        ...
        {/* Guidelines - Collapsible on both mobile and desktop */}
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg pl-10 pr-4 py-2.5 text-sm text-white placeholder-gray-400 focus:outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/50 transition"
            />
          </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="text-white font-semibold mb-1">Student Found</p>
                  <p className="text-gray-300 text-sm">
                    <span className="font-medium">{searchResult.student.name}</span> is registered for cleaning on:
                  </p>
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                      searchResult.student.status === 'attended' ? 'bg-green-500/20 text-green-400' :
                      searchResult.student.status === 'pending' ? 'bg-yellow-500/20 text-yellow-400' :
