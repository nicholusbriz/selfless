  ...
  return (
    <BackgroundImage className="min-h-screen relative overflow-hidden">
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        ...
        <div className="absolute top-20 right-20 w-40 h-40 bg-purple-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-10 left-1/3 w-36 h-36 bg-indigo-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 right-1/4 w-28 h-28 bg-pink-400/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>

        <div className="w-full max-w-lg relative z-10">
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl p-8" style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 100%)', backdropFilter: 'blur(20px)' }}>
            <div className="text-center mb-6">
              ...
              {/* Modern Title */}
              <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-cyan-200 to-blue-300 bg-clip-text text-transparent mb-4" style={{
              ...
              {/* Modern Subtitle */}
              <p className="text-lg md:text-xl text-white/80 font-light mb-6" style={{
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-white/90 mb-3 tracking-wide">
                  Email Address
                </label>
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`relative w-full px-5 py-4 bg-white/10 backdrop-blur-md border rounded-2xl text-white placeholder-white/50 focus:outline-none transition-all duration-300 text-base font-medium ${isFocused
                      ? 'border-blue-400/60 bg-white/15 shadow-lg shadow-blue-500/20'
                      : 'border-white/20 hover:border-white/30'
                      }`}
                    placeholder="your@email.com"
                    required
                  />
                  <div className={`absolute right-4 top-1/2 transform -translate-y-1/2 transition-all duration-300 ${isFocused ? 'text-blue-300 scale-110' : 'text-white/50'
                    }`}>
              ...
              <LoadingButton
                ...
                className="relative w-full bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white font-semibold py-4 px-8 rounded-2xl hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 focus:outline-none focus:ring-4 focus:ring-blue-500/30 focus:ring-offset-2 focus:ring-offset-transparent transition-all duration-500 transform hover:scale-[1.02] shadow-xl hover:shadow-2xl hover:shadow-blue-500/40 text-base overflow-hidden group"
            ...
            <div className="mt-8 space-y-6">
              <div className="flex justify-center gap-3">
                <button
                  ...
                  className="group relative px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white/90 font-medium hover:bg-white/20 hover:border-white/30 transition-all duration-300 transform hover:scale-105"
                >
                ...
                <button
                  onClick={() => router.push('/')}
                  className="group relative px-6 py-3 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl text-white/70 font-medium hover:bg-white/10 hover:border-white/20 hover:text-white/90 transition-all duration-300 transform hover:scale-105"
                >
                  <span className="flex items-center">
