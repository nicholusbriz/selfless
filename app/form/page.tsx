      ...
      <div className="relative z-10 container mx-auto px-4 py-8 h-full flex flex-col">
        <div className="overflow-y-auto flex-1">
          ...
          <div className="max-w-4xl mx-auto mb-12 animate-fade-in-up animation-delay-300">
            <div className={`glass-card rounded-3xl p-10 border-2 shadow-glow-lg hover-lift transition-all duration-500 ${isRegistered
              ? 'border-emerald-400/30 shadow-emerald-400/20'
        ...
        {message && (
          <div className={`max-w-4xl mx-auto mb-12 animate-fade-in-up`}>
            <div className={`glass-card rounded-3xl p-8 text-center border-2 shadow-glow-lg ${messageType === 'success'
              ? 'border-emerald-400/30 shadow-emerald-400/20'
        ...
        <div className="max-w-7xl mx-auto animate-fade-in-up animation-delay-500">
          <div className="glass-card rounded-3xl p-10 border-2 border-blue-400/30 shadow-glow-lg">
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-6">
                      <div className="flex items-center space-x-4">
                        ...
                        />
                        <div>
                          <h4 className={`font-bold text-2xl mb-2 ${day.isFull ? 'text-gray-300' : 'text-white'}`}>
                            {day.dayName}
                          </h4>
                          <p className={`text-base ${day.isFull ? 'text-gray-400' : 'text-gray-200'}`}>
                    ...
                    <div className="flex items-center justify-between mb-6">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <span className={`text-lg font-semibold ${day.isFull ? 'text-red-300' : 'text-blue-300'}`}>
                            {day.registeredCount}/{day.maxSlots}
                          </span>
                          <p className={`text-sm ${day.isFull ? 'text-gray-400' : 'text-gray-300'}`}>
                            Spots Available
                          </p>
                        </div>
                      </div>
